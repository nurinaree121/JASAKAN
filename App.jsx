...
import { CategoryList, ListBlog, JasaList } from './src/components';
import { blogData, dataJasa, categories } from './src/data';
    ...
    <View style={styles.container}>
      <View style={styles.header}>
        <View style={{ flexDirection: "row", alignItems: "center" }}>
          ...
          <Text style={[styles.title, { marginLeft: 5 }]}>JasaKan</Text>
        </View>
      </View>
